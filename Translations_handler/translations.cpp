...
const Translation translations[] = {
  ...
  {"CONTROL_SALA_MENU",         "Control",                   "Control",                  "Control",                        "Kontrola",                           "Contrôle",                          "Steuerung",                   "Control",                    "Controllo"},
  ...
  {"NO_DELETE",                 "No",                        "No",                       "No",                             "Ez",                                 "Non",                               "Nein",                        "No",                         "No"},
  ...
  {"RESTORE_ELEM",              "Restablecer elementos",     "Restablecer elementos",    "Restableix elements",            "Berreskuratu elementuak",            "Restaurer les elements",            "Elemente wiederherstellen",   "Restore elements",           "Ripristina elementi"},
  {"RESTORE_ELEM",              "Restablecer elementos",     "Restablecer elementos",    "Restableix elements",            "Berreskuratu elementuak",            "Restaurer les elements",            "Elemente wiederherstellen",   "Restore elements",           "Ripristina elementi"},
  {"UPDATING",                  "Actualizando",              "Actualizando",             "Actualitzant",                   "Eguneratzen",                        "Mise a jour",                       "Aktualisiere",                "Updating",                   "Aggiornamento" },
  ...
  {"MENU_AJUSTAR_BRILLO",       "AJUSTAR BRILLO",            "AJUSTAR BRILLO",           "AJUSTAR LLUM",                   "DISTIR BRILOA",                      "AJUSTER LUMIERE",                   "HELLIGKEIT EINST.",           "ADJUST BRIGHTNESS",          "REGOLA LUMINOSITA"},
  {"BRILLO_NORMAL",             "Normal",                    "Normal",                   "Normal",                         "Normala",                            "Normal",                            "Normal",                      "Normal",                     "Normale"},
  {"BRILLO_ATENUADO",           "Atenuado",                  "Atenuado",                 "Atenuat",                        "Ahulduta",                           "Attenue",                           "Gedimmt",                     "Dimmed",                     "Attenuato"},
  {"CARGAR_BATERIA",            "Cargar batería",            "Cargar batería",           "Carrega la bateria",             "Bateria kargatu",                    "Charger la batterie",               "Batterie laden",              "Charge battery",             "Carica batteria" },
  {"RESTORE_ROOM",              "¿Restaurar sala?",          "¿Restaurar sala?",         "Restaurar sala?",                "Gela berreskuratu?",                 "Restaurer la salle ?",              "Raum wiederherstellen?",      "Restore room?",              "Ripristinare stanza?" },
  {"RESTORE",                   "¿Restaurar?",               "¿Restaurar?",              "Restaurar?",                     "Berreskuratu?",                      "Restaurer ?",                       "Wiederherstellen?",           "Restore?",                   "Ripristinare?" },
  {"DADO",                      "Dado",                       "Dado",                       "Dau",                        "Dado",                         "Dé",                           "Würfel",                    "Dice",                      "Dado"},
  {"ELEMENTOS_ADICIONALES",     "Elementos adicionales",      "Elementos adicionales",      "Elements addicionals",       "Elementu osagarriak",          "Éléments additionnels",        "Zusätzliche Elemente",      "Additional Elements",       "Elementi aggiuntivi"},
  {"HABILITADO",                "Habilitado",                 "Habilitado",                 "Habilitat",                  "Gaituta",                      "Activé",                       "Aktiviert",                 "Enabled",                   "Abilitato"},
  {"DESHABILITADO",             "Deshabilitado",              "Deshabilitado",              "Deshabilitat",               "Desgaituta",                   "Désactivé",                    "Deaktiviert",               "Disabled",                  "Disabilitato"},
  {"HABILITAR_DADO",            "Habilitar Dado",             "Habilitar Dado",             "Habilitar el Dau",           "Dadoa gaitu",                  "Activer le dé",                "Würfel aktivieren",         "Enable Dice",               "Abilitare il dado"},
